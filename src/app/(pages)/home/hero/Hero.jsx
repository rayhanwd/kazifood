    ...
    <section className="text-gray-600 body-font">
      <div className="container mx-auto px-5 py-24 ">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className=" lg:text-4xl sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center">
          ...
          <button className="text-white w-auto bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg text-3xl">
            Find restaurant
          </button>
        </div>
      </div>
